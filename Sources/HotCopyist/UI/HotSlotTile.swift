...
struct HotSlotTile: View {
    ...
    var onClear: () -> Void
    var onRename: () -> Void
    /// A history/slot item id was dropped onto this slot.
    var onDropItem: (_ id: UUID) -> Void
        ...
        ZStack {
            if dropTargeted {
                RoundedRectangle(cornerRadius: 7, style: .continuous)
                    .fill(Theme.mint.opacity(0.22))
                RoundedRectangle(cornerRadius: 7, style: .continuous)
                    .stroke(Theme.mint, lineWidth: 1.5)
            } else if item != nil {
                RoundedRectangle(cornerRadius: 7, style: .continuous)
                ...
                RoundedRectangle(cornerRadius: 7, style: .continuous)
                    .fill(Color.primary.opacity(hovering ? 0.045 : 0.015))
                RoundedRectangle(cornerRadius: 7, style: .continuous)
